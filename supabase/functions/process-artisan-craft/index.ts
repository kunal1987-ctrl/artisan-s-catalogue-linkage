    ...
    if (geminiApiKey) {
      const geminiPayload = {
        systemInstruction: {
          parts: [
            {
              text: `You are Shilp Setu's authentic artisan inventory verification and cataloging engine. You are given an image of a handmade craft and a transcribed artisan voice note.

...
export const validateImageLightweight = (file: Blob | File): Promise<ValidationResult> => {
...
export const getLocalizedValidationReason = (reason: string, lang: string = 'en'): string => {
